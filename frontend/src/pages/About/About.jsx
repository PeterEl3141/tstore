  ...
  return (
    <section className="about">
      ...
      <p className="about-text">
        ...
        This music was, and is, revolutionary (or it would not still be relevant).
        We hope to infuse this revolutionary spirit back into it's imagery.
        A quixotic - perhaps even ridiculous endevour.
        But one that someone must rise to!
      
      </p>
      <p className="about-text">
        Each design is limited-run and produced responsibly via our print partner.
      </p>
    </section>
  );
}
